...
![Placeholders example](media/screenshots/example_map_placeholders.png)

#### After: drawn map

![Drawn map example](media/screenshots/example_map_drawn.png)

### Demo videos

- [Setup example](media/videos/example_setup_PolyGrid2D.mp4)
- [Terrain generation example](media/videos/example_terrain_generation_PolyGrid2D.mp4)
